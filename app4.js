...
function generateQuestion() {
        ...
        let num1, num2;
        do {
            num1 = Math.floor(Math.random() * 10) + 1; // Generate random number for num1
            num2 = Math.floor(Math.random() * num1) + 1; // Generate random number for num2 less than num1
        } while (num1 % num2 !== 0 || num2 % 2 !== 0); // Ensure num1 is divisible by num2 and num2 is even
